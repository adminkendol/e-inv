...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title"><h4 class="title">Penjualan Stats</h4></div>
    ...
    <div class="panel-body">
        <div class="form-group">
            <div>
                <a type="button" href="<?php echo base_url().'core/addjual'; ?>" class="btn btn-blue pull-right">Tambah Penjualan</a>
            </div>
        </div>
    </div>
